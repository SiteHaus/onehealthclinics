        ...
        <div className="flex flex-col lg:flex-row max-w-6xl mx-auto gap-12 px-6">
          ...
          <div className="w-full lg:w-1/2 text-muted-foreground font-semibold text-lg text-center md:text-xl">
            <p className="pb-10">
              ...
              internal medicine and personalized attention. For 20 years, we've
              had the privilege of being your medical home as Dixie Primary
              Care.
            </p>

            <p>
              As our community grew, so did our scope. We've evolved far beyond
              a traditional primary care office — managing complex chronic
              conditions, performing specialized procedures, and offering
              wellness care for every stage of life.
            </p>
          </div>
        </div>
      </section>
      <section className="w-full py-5 lg:py-10 bg-white">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center lg:items-stretch gap-10 mt-12">
            <Card className="w-[280px] bg-[#D9D9D9] h-full flex flex-col bg-white rounded-lg border border-border shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <CardHeader className="flex flex-col gap-4">
                ...
                <CardTitle className="text-primary">All-in-one care</CardTitle>
              </CardHeader>
            ...
            <Card className="w-[280px] bg-[#D9D9D9] h-full flex flex-col bg-white rounded-lg border border-border shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <CardHeader className="flex flex-col gap-4">
                ...
                <CardTitle className="text-primary">Built for growth</CardTitle>
              </CardHeader>
