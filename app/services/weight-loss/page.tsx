      ...
      <section className="bg-hero-bg py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-background mb-6">
            Medical Weight Loss in St. George, Utah
          </h1>
          <p className="max-w-2xl text-white/80 text-lg leading-relaxed">
            Guided by your primary care provider with full knowledge of your
            medical history — not a one-size-fits-all clinic.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1 flex flex-col gap-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              As your primary care provider, we guide your weight loss journey
              with full knowledge of your medical history and current
              medications. We offer Semaglutide (GLP-1 RA) and Tirzepatide (dual
              GIP/GLP-1 agonist) to reduce appetite, slow gastric emptying, and
              improve insulin sensitivity.
            </p>
            <p className="text-gray-600 leading-relaxed">
              We also offer Lipo Mino injections alongside these medications — a
              lipotropics and B-vitamin blend to further boost fat burning and
              energy levels.
            </p>
            <Link
