    ...
    <div className="w-full text-white">
      <section className="bg-hero-bg py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <nav className="text-white/40 text-sm mb-4 flex gap-2">
            ...
            <span>/</span>
            <span className="text-white/70">Hormone Therapy</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-background mb-6">
            Hormone Replacement Therapy in St. George, Utah
          </h1>
          <p className="max-w-2xl text-white/80 text-lg leading-relaxed">
            Restore hormonal balance and relieve fatigue, mood changes, weight gain, and low libido with personalized HRT.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row-reverse gap-12 items-center">
          <div className="flex-1 flex flex-col gap-6">
            <div>
              ...
              <h2 className="text-2xl font-bold mb-4">Bioidentical HRT & Pellet Therapy</h2>
            </div>
            <p className="text-gray-600 leading-relaxed">
              We have completed additional training in bioidentical hormone replacement therapy and pellet therapy. HRT helps restore hormonal balance when your body's natural production declines, relieving symptoms such as fatigue, mood changes, weight gain, sleep disturbances, and low libido.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Available in topical, oral, injectable, and pellet forms, HRT supports improved energy, mental clarity, and overall well-being — tailored to your specific hormone levels and health goals.
            </p>
            <Link
          ...
          <div className="w-full md:w-2/5 rounded-2xl overflow-hidden shadow-md aspect-[4/3] flex-shrink-0">
            <img
              src="/zen.jpg"
              alt="Hormone replacement therapy in St. George, Utah"
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Ready to restore your balance?</h2>
