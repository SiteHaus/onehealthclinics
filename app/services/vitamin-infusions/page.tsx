    ...
    <div className="w-full text-white">
      <section className="bg-hero-bg py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <nav className="text-white/40 text-sm mb-4 flex gap-2">
            ...
            <span>/</span>
            <span className="text-white/70">Vitamin Infusions</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-background mb-6">
            IV Vitamin Infusions in St. George, Utah
          </h1>
          <p className="max-w-2xl text-white/80 text-lg leading-relaxed">
            Fast, deep hydration and immune support — each infusion customized by your primary care provider.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row-reverse gap-12 items-center">
          <div className="flex-1 flex flex-col gap-6">
            <div>
              ...
              <h2 className="text-2xl font-bold mb-4">IV Therapy at OneHealth</h2>
            </div>
            <p className="text-gray-600 leading-relaxed">
              We offer a wide range of IV therapy services to boost your immune system, reduce toxin load and inflammation, increase energy, and allow fast, deep hydration. Each treatment contains a unique combination of nutrients crafted to promote overall wellness.
            </p>
            <p className="text-gray-600 leading-relaxed">
              As your primary care provider, we determine which treatment is best for you and ensure it won't interact with your current medications.
            </p>
            <Link
          ...
          <div className="w-full md:w-2/5 rounded-2xl overflow-hidden shadow-md aspect-[4/3] flex-shrink-0">
            <img
              src="/vitinf.jpg"
              alt="IV vitamin infusion therapy in St. George, Utah"
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Ready to feel your best?</h2>
