    ...
    <div className="w-full text-white">
      <section className="bg-hero-bg py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <nav className="text-white/40 text-sm mb-4 flex gap-2">
            ...
            <span>/</span>
            <span className="text-white/70">PRP Injections</span>
          </nav>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-background mb-6">
            PRP & Joint Injections in St. George, Utah
          </h1>
          <p className="max-w-2xl text-white/80 text-lg leading-relaxed">
            A natural path to restored mobility — without surgery. Treat joint pain, tendinitis, and osteoarthritis with your body's own healing power.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1 flex flex-col gap-6">
            <div>
              ...
              <h2 className="text-2xl font-bold mb-4">How PRP Works</h2>
            </div>
            <p className="text-gray-600 leading-relaxed">
              Platelet-rich plasma (PRP) injections accelerate healing, reduce pain, and enhance tissue regeneration by concentrating platelets loaded with growth factors. Combined with hyaluronic acid, these injections improve tendinitis, osteoarthritis, joint pain, muscle strains, and ligament injuries.
            </p>
            <p className="text-gray-600 leading-relaxed">
              This approach offers a natural path to restored mobility that can help avoid or delay surgery — using your body's own biology to heal.
            </p>
            <Link
          ...
          <div className="w-full md:w-2/5 rounded-2xl overflow-hidden shadow-md aspect-[4/3] flex-shrink-0">
            <img
              src="/prp.webp"
              alt="PRP joint injections in St. George, Utah"
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Ready to move without pain?</h2>
