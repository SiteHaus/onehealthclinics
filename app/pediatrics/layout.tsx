...
export const metadata: Metadata = {
  ...
  description:
    "Formerly Dixie Primary Care — now OneHealth Clinics. Expert pediatric care in St. George, Utah. Well-child visits, immunizations, sports physicals, and same-day urgent care for kids.",
  keywords: [
